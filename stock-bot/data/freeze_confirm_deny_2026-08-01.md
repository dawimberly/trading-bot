# Freeze weekly confirm/deny plan — week ending 2026-08-01

Generated: 2026-08-01 14:15 UTC
...
| 5 | `daily_errors_present` | **HOLD** | CONFIRM / DENY / HOLD | Today's error log has 1 error(s) |
| 6 | `attribution_stale` | **CONFIRM** | CONFIRM / DENY / HOLD | Sleeve attribution stale (67h) |
...
- 2026-07-30: `freeze_daily_2026-07-30.md` (943 bytes)
- 2026-07-31: `freeze_daily_2026-07-31.md` (943 bytes)
...
- `attribution_stale` [cleanup] default=CONFIRM: Sleeve attribution stale (67h) — Run: python scripts/analysis/forward_sleeve_attribution.py
