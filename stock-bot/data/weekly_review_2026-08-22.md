# Paper Weekly Research — 2026-08-22
...
- Nyse unrealized +670 (MTM).
- Core unrealized -386 (MTM).
...
**Rationale:** Single factor under investigation: core sleeve is the weakest 7d contributor (contrib=-386.07, -39.9 bps of book).
...
|--------|----------|-----------|---|
| Return | 3.06% | 3.03% | -0.03 pp |
| Sharpe | 1.09 | 1.07 | -0.02 |
| Max DD | -3.75% | -3.75% | 0.00 pp |

## Recommendation
**HOLD** — Effect size mixed / within noise (ΔReturn=-0.03pp, ΔSharpe=-0.02, Δ|DD|=+0.00pp.) Gather another week of clean data. Caveats: data grade C; thin closed-trade sample; mandate unreliable.
...
## Appendix
**Wisdom (last 3):**
- 2026-08-20: ret=-0.7212211526213319 sharpe=None
- 2026-08-21: ret=0.39947705877509954 sharpe=None
- 2026-08-22: ret=-4.132501638665076e-05 sharpe=None
**Notes:**
