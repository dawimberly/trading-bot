# Freeze weekly confirm/deny plan — week ending 2026-08-08

Generated: 2026-08-08 14:15 UTC
...
| 5 | `daily_errors_present` | **HOLD** | CONFIRM / DENY / HOLD | Today's error log has 4 error(s) |
...
- 2026-08-02: `freeze_daily_2026-08-02.md` (943 bytes)
- 2026-08-03: `freeze_daily_2026-08-03.md` (1358 bytes)
- 2026-08-04: `freeze_daily_2026-08-04.md` (1358 bytes)
- 2026-08-05: `freeze_daily_2026-08-05.md` (1726 bytes)
- 2026-08-06: `freeze_daily_2026-08-06.md` (970 bytes)
- 2026-08-07: `freeze_daily_2026-08-07.md` (1752 bytes)
...
- `daily_errors_present` [cleanup] default=HOLD: Today's error log has 4 error(s) — Review obvious repeats; do not retune strategy from errors alone.
...
Period equity: $94,466.28 -> $97,315.92 (+3.02%) | equity_source: `journal_equity_marks` | closed exits: 0
...
- rows_in_window: 3403 / rows_total: 14533
- window_ts: 2026-07-29 17:33:44+00:00 → 2026-08-07 17:15:32+00:00
- equity_source: `journal_equity_marks` (marks_in_window=2738)
- fills_count: 0 | exits_count: 0 | spy_fills: 0
- event_counts: `{'cycle': 2738, 'startup': 626, 'exit_error': 24, 'error': 15}`
...
|--------|------:|------:|-------------:|---------:|-----------:|---------:|-----:|
| nyse | 0 | 0 | $0.00 | n/a | $355.84 | $68,298.47 | 25 |
| vti_core | 0 | 0 | $0.00 | n/a | $0.00 | $48,887.09 | 1 |
| metal | 0 | 0 | $0.00 | n/a | $7.43 | $7,803.29 | 1 |
| spy | 0 | 0 | $0.00 | n/a | $-0.02 | $98.72 | 1 |
...
- journal_load: candidate paper_journal.csv: rows=14533 ts_max=2026-08-07 17:15:32+00:00
- journal_load: candidate paper_chase_journal.csv: rows=818 ts_max=2026-07-23 13:38:42+00:00
- journal_load: candidate paper_jou
```
