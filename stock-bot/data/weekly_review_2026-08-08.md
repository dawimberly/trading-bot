# Paper Weekly Research — 2026-08-08

_Paper book only. Never auto-applies `.env`. Live Profile A is read-only here._

## Executive Decision
**HOLD** — Monitor only — data too sparse (grade C, 0 closes); track `PAPER_SPY_MAX_EXPOSURE_PCT=0.02` until grade B+ and 90d A/B.

Treatment under review: `PAPER_SPY_MAX_EXPOSURE_PCT=0.02` · _monitor only_
...
- Nyse unrealized +349 (MTM).
- Metal unrealized +3 (MTM).
- Wisdom daily returns supportive this week.
...
Best **nyse** (+349) · Worst **spy** (+0)

| Sleeve | Realized | Unrealized | Contrib | Cls | Src |
|--------|----------|------------|---------|-----|-----|
| nyse | +0 | +349 | +349 | 0 | unrealized |
| metal | +0 | +3 | +3 | 0 | unrealized |
...
**Proposed change:** `PAPER_SPY_MAX_EXPOSURE_PCT=0.02` (current `0.0`)
**Rationale:** Single factor under investigation: spy sleeve is the weakest 7d contributor (contrib=+0.14, 0.0 bps of book).
**Mechanism:** Tighten `PAPER_SPY_MAX_EXPOSURE_PCT` from 0.0 → 0.02 to change that sleeve's capital allocation while holding all other policy constants fixed.
...
_Baseline: timeout after 3600s: Command '['C:\\Users\\Owner\\PythonTrading\\.venv\\Scripts\\python.exe', 'C:\\Users\\Owner\\PythonTrading\\stock-bot\\backtester.py', '--days', '90', '--paper-aggressive']' timed out after 3600 seconds_
_Treatment: timeout after 3600s: Command '['C:\\Users\\Owner\\PythonTrading\\.venv\\Scripts\\python.exe', 'C:\\Users\\Owner\\PythonTrading\\stock-bot\\backtester.py', '--days', '90', '--paper-aggressive']' timed out after 3600 seconds_

## Recommendation
**HOLD** — Controlled experiment incomplete (baseline_ok=False, proposed_ok=False; timeout after 3600s: Command '['C:\\Users\\Owner\\PythonTrading\\.venv\\Scripts\\python.exe', 'C:\\Users\\Owner\\PythonTrading\\stock-bot\\backtester.py', '--days', '90', '--paper-aggressive']' timed out after 3600 seconds | timeout after 3600s: Command '['C:\\Users\\Owner\\PythonTrading\\.venv\\Scripts\\python.exe', 'C:\\Users\\Owner\\PythonTrading\\stock-bot\\backtester.py', '--days', '90', '--paper-aggressive']' timed out after 3600 seconds).

## Implementation (paper only)
**Monitor only** — no `.env` change this week.
- Watch: `PAPER_SPY_MAX_EXPOSURE_PCT=0.02`
- Promote only after grade B+, ≥5 closed trades, and 90d A/B APPROVE.
- Do **not** copy to live.

## Appendix
**Wisdom (last 3):**
- 2026-08-06: ret=-0.5109136810565684 sharpe=None
- 2026-08-07: ret=0.42971985011519553 sharpe=None
- 2026-08-08: ret=-0.006598599678475647 sharpe=None
**Notes:**
