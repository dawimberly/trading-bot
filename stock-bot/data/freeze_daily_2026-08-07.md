# Freeze daily hygiene — 2026-08-07

Generated: 2026-08-07 21:30 UTC
Equity: 97312.3 | Regime: RHYME_C: Steady_Bullish_Growth | Heartbeat age: 0m
...
|----|-----|---------|------|--------|
| `daily_errors_present` | cleanup | **HOLD** | Today's error log has 4 error(s) | Review obvious repeats; do not retune strategy from errors alone. |
| `attribution_stale` | cleanup | **CONFIRM** | Sleeve attribution stale (51h) | Run: python scripts/analysis/forward_sleeve_attribution.py |
...
- Evidence: `C:\Users\Owner\PythonTrading\stock-bot\logs\daily_errors_2026-08-07.md`
