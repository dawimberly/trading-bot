...
## Friends: download from GitHub

Same monorepo as the stock bot: [github.com/dawimberly/trading-bot](https://github.com/dawimberly/trading-bot)
...
See [FRIENDS.md](../FRIENDS.md) for Mac/Linux and troubleshooting. First run trains the model locally (~15–30 min).
